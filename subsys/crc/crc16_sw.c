...
uint16_t __weak crc16(uint16_t poly, uint16_t seed, uint8_t const* src, size_t len) {
    uint16_t crc = seed;
    size_t i;
    size_t j;
...
uint16_t __weak crc16_reflect(uint16_t poly, uint16_t seed, uint8_t const* src, size_t len) {
    uint16_t crc = seed;
    size_t i;
    size_t j;
...
uint16_t __weak crc16_ccitt(uint16_t seed, uint8_t const* src, size_t len) {
    for (; len > 0; len--) {
        uint8_t e, f;
...
uint16_t __weak crc16_itu_t(uint16_t seed, uint8_t const* src, size_t len) {
    for (; len > 0; len--) {
        seed = BSWAP_16(seed);
        seed ^= *src;
        ++src;
