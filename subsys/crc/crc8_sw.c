...
uint8_t __weak crc8_ccitt(uint8_t val, void const* buf, size_t len) {
    uint8_t const* p = buf;
...
uint8_t __weak crc8_rohc(uint8_t val, void const* buf, size_t len) {
    uint8_t const* p = buf;
...
uint8_t __weak crc8(uint8_t const* src, size_t len,
