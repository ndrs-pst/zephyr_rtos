...
static int settings_list_callback(char const* key,
                                  size_t len,
...
static int settings_read_callback(char const* key,
                                  size_t len,
                                  settings_read_cb read_cb,
                                  void* cb_arg,
                                  void* param) {
...
static int settings_parse_type(char const* type, enum settings_value_types* value_type) {
