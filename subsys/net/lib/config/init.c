...
int /**/net_config_init_by_iface(struct net_if* iface, char const* app_info,
...
int net_config_init(char const* app_info, uint32_t flags,
                    int32_t timeout) {
...
int net_config_init_app(const struct device* dev, char const* app_info) {
