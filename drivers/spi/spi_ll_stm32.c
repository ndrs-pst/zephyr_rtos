 ...
 * e.g. nucleo_f746zg
 */
#if (defined(CONFIG_CPU_HAS_DCACHE) && defined(CONFIG_DCACHE) && !defined(CONFIG_NOCACHE_MEMORY))
 ...
 */
static __aligned(32) uint32_t dummy_rx_tx_buffer __attribute__((__section__(".nocache")));
