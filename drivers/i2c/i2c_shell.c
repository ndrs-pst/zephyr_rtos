...
__maybe_unused static int cmd_i2c_target_register(struct shell const* sh, size_t argc, char** argv) {
    char* s_dev_name = argv[ARGV_DEV];
    const struct device* dev;
    int ret;
...
__maybe_unused static int cmd_i2c_target_unregister(struct shell const* sh, size_t argc,
                                                    char** argv) {
    char* s_dev_name = argv[ARGV_DEV];
    const struct device* dev;
    int ret;
...
#define SHELL_CMD_SUB_I2C_TARGET \
