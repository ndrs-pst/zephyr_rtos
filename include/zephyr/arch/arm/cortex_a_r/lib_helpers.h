...
static inline uint32_t read_sysreg32(int op1, int CRn, int CRm, int op2) {
    return (0U);
}

static inline void write_sysreg32(int val, int op1, int CRn, int CRm, int op2) {
    /* pass */
}

static inline uint64_t read_sysreg64(int op1, int CRm) {
    return (0ULL);
}

static inline void write_sysreg64(uint64_t val, int op1, int CRm) {
    /* pass */
}
#else
