...
#define K_SEM_DEFINE(name, initial_count, count_limit) \
    ...
    BUILD_ASSERT(((count_limit) != 0) && ((initial_count) <= (count_limit)) && ((count_limit) <= K_SEM_MAX_LIMIT));
...
#define K_MSGQ_DEFINE(q_name, q_msg_size, q_max_msgs, q_align)      \
    ...
    STRUCT_SECTION_ITERABLE(k_msgq, q_name) = Z_MSGQ_INITIALIZER(q_name, _k_fifo_buf_##q_name, (q_msg_size), (q_max_msgs))
...
#define K_MBOX_DEFINE(name) \
    STRUCT_SECTION_ITERABLE(k_mbox, name) = Z_MBOX_INITIALIZER(name)
